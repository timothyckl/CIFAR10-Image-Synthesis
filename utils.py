# credit: https://github.com/jleinonen/keras-fid
...
class FrechetInceptionDistance(object):
	...
	def __init__(self, generator, image_range, generator_postprocessing=None):
	...
	def _stats(self, inputs, input_type="real", postprocessing=None,
		...
		for i in range(num_batches):
			try:
				...
				# assume that an array or a list of arrays was passed instead
